...
/**************************************************************************** 
 ...
 $ @ 最后修改: 2024-11-21 16:20:51
 $ @ 文件路径: /wp-content/themes/XuWbk/pages/xuwbk-sponsor.php
 $ @ 简要说明: 有问题联系作者：QQ:181682233 邮箱：japhia@mail.com 网址：waimao.la
 $ @ Copyright (c) 2024 by Japhia, All Rights Reserved. 
 ****************************************************************************/
// 检查后台开关状态
$options = get_option('XuWbk');
$zanzu_page = isset($options['zanzu-page']) ? $options['zanzu-page'] : false;
if (!($zanzu_page === true || $zanzu_page === '1' || $zanzu_page === 1)) {
...
<main class="container">
                                ...
                                <section style="display: inline-block;vertical-align:middle;" powered-by="mengdo.cn"
                                    ...
                                    <section style="display: flex;align-items: center;justify-content: space-between;"
                                        ...
                                        <section style="width:21px;margin: 0 -9px 8px auto;line-height:2px;"
                                            powered-by="mengdo.cn" data-md5="023bb" class="style_6"><images
                                                src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu3.png'?>"
                                                style="vertical-align:middle;width:100%;" class="small_image style_7"
                                                _src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu3.png'?>" data-isstyleimage="1"
                    ...
                    <div class="wzw-programme-content">
                        <ul class="wzw-money-wrap">
                            <li data-pay="10" class="wzwco wzw-money-item main-shadow radius8">
                                ...
                                <images class="wzw-money-icon" src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/1.png'?>" alt="一个鸡腿"
                                    draggable="false" />
                            ...
                            <li data-pay="20" class="wzwco wzw-money-item main-shadow radius8">
                                ...
                                <images class="wzw-money-icon" src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/2.png'?>" alt="一杯咖啡"
                                    draggable="false" />
                            ...
                            <li data-pay="30" class="wzwco wzw-money-item main-shadow radius8">
                                ...
                                <images class="wzw-money-icon" src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/4.png'?>" alt="一个汉堡"
                                    draggable="false" />
 ...
 .'/assets/images/page/5.png'?>"
                            ...
                            <li data-pay="100" class="wzwco wzw-money-item main-shadow radius8">
                                ...
                                <images class="wzw-money-icon" src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/3.png'?>" alt="一份全家桶"
                                    draggable="false" />
                            ...
                            <li data-pay="zdy" class="wzwco wzw-money-item main-shadow radius8">
                                ...
                                <images class="wzw-money-icon" src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/6.png'?>" alt="爱心红包"
                                    draggable="false" />
                        ...
                        <section data-id="120340" class="wzweditor style_1" data-type="lspecial04,lspecial06"
                            ...
                            <section style="display: flex;align-items: center;justify-content: center;"
                                ...
                                <section style="width:40px;line-height:2px;" powered-by="mengdo.cn" data-md5="997e1"
                                    class="style_3"><images src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu1.png'?>"
                                        style="vertical-align:middle;width:100%;" class="small_image style_4"
                                        _src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu1.png'?>" data-isstyleimage="1"
                                ...
                                <section style="width:40px;line-height:2px;" powered-by="mengdo.cn" data-md5="997e1"
                                    class="style_16"><images src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu2.png'?>"
                                        style="vertical-align:middle;width:100%;" class="small_image style_17"
                                        _src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu2.png'?>" data-isstyleimage="1"
                                        draggable="false" data-md5="997e1"></section>
                            </section>
                        </section>
                    </div>
                    <div class="wzw-programme-content box-body theme-box">
                                    ...
                                    <section style="-webkit-box-flex: 1;width: 0;margin-bottom:1px;"
                                        ...
                                        <section class="wxqq-Color style_10"
                                            ...
                                            <p class="wzwbrush style_11"
                                                ...
                                                <?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>会努力坚持做到：</p>
                                        </section>
                        ...
                        <div class="wzw-text-wrap">
                            <div class="wp-block-zibllblock-feature feature wzwco feature-default" data-icon="fa-flag">
                                <div class="feature-icon"><images class="icon"
                                        src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/1.svg'?>" /></div>
 ...
 .'/assets/images/page/4.svg'?>" /></div>
                                                ...
                                                <section
                                                    ...
                                                    <section class="wxqq-Color style_12"
                                                        ...
                                                        <p class="wzwbrush style_13"
                                                            ...
                                                            data-md5="6a933">
                                                            <?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>上线以来，努努力加加班定时更新一好玩的教程，几年下来也慢慢教程质量有了一些提升，加上发布教程完全免费（积分通过签到获取，即免费），能坚持这么多年也是很不容易的，随着时间的推移，维持网站的运行需要支出高昂的服务器和带宽费用。为了能继续坚持免费做下去，<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>希望大家能够赞助<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>，给<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>加油打气！激励<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>继续创作下去！谢谢！
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                ...
                                <section style="display:-webkit-box;-webkit-box-pack:center;-webkit-box-align:end;"
                                    ...
                                    <section style="-webkit-box-flex: 1;width: 0;margin-bottom:1px;"
                                        ...
                                        <section class="wxqq-Color style_10"
                                            ...
                                            <p class="wzwbrush style_11"
                                                style="padding: 0px;margin: 0px;font-size: 18px;" data-md5="2ece3">
                                                还有其他支持<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>的渠道或者方式吗？</p>
                                        </section>
                                        <section class="wxqq-borderTopColor style_12"
                                            style="width:100%;height:0px;box-sizing: border-box;border-top:2px solid #FF977B;"
                                            powered-by="mengdo.cn" data-md5="2ece3"></section>
                        ...
                        <hr />
                        <div class="wzw-text-content">
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;目前暂时没有其他渠道，如果您想以QQ支付的方式赞助<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>可以加<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>QQ赞助<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>，所有赞助服务均有效。
                            </p>
                        </div>
                        <!--4-->
                            ...
                            <section style="text-align: center;" powered-by="mengdo.cn" data-md5="de993"
                                ...
                                <section class="wxqq-Color style_3"
                                    ...
                                    <p class="wzwbrush style_4" style="padding: 0px;margin: 0px;" data-md5="de993">
                                        <?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?>-<?php echo isset($options['zanzu-page-url']) ? $options['zanzu-page-url'] : ''; ?></p>
                                </section>
                                ...
                                <section
                                    ...
                                    powered-by="mengdo.cn" data-md5="de993" class="style_13"><images
                                        src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu4.gif'?>"
                                        style="vertical-align:middle;width:100%;" class="small_image style_14"
                                        data-isstyleimage="1" data-md5="de993"
                                        _src="<?php echo get_stylesheet_directory_uri()
 .'/assets/images/page/zu4.gif'?>"></section>
                            </section>
                        </section>
                    </div>
                </div>
                    ...
                    <div class="wzw-modal-body modal-body">
                        <div class="wzw-donate-modal-zfm modal-body">
                            <div class="wzw-donate-modal-title dsjb">
                                <b>赞助发电❤支持<?php echo isset($options['zanzu-page-name']) ? $options['zanzu-page-name'] : ''; ?></b>
                                <p class="wzwi_pay-title">加载中...</p>
                            </div>
                            <div class="wzw-donate-modal-ewm">
                                <images src="" draggable="false" />
                            </div>
                            <p>长按保存支付二维码</p>
    ...
    <script>
        ...
        function actv_zf_func(pay_ty) {
            ...
            $(".wzw-donate-modal-ewm>images").attr("src", "<?php echo isset($options['zanzu-page-pay-url']) ? $options['zanzu-page-pay-url'] : '';?>" + pay_ty + "/" + pay_money + ".jpg");
        }
