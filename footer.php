...
<div class="footer-fav">
    <div class="wrapper footer-fav-top">
        <div class="Onecad_fl site-info">
            <h2><span class="site-title-mobile">轩玮博客</span> <span class="site-domain-mobile">www.xuwbk.com</span></h2>
            <div class="site-p">
                <p>本站建站至今始终努力坚持搜集和分享各种网络知识以及IT科技，现如今本站已发展形成网站源码、建站程序、WordPress教程、CMS、美图集合、实用软件、经验教程、影视资源等各个领域的资源！</p>
            </div>
        </div>
        ...
        <div class="site-girl">
            ...
            <div class="girl-info hide_md">
                <h4>管理员介绍</h4>
                <h4>轩玮博客 专注于精品源码分享</h4>
            </div>
        </div>
    </div>
</div>

<footer id="onecad_new_footer" class="onecad_new_footer bg_img" style="background-image: url(https://img.alicdn.com/imgextra/i4/2210123621994/O1CN012hz5uy1QbIqZO9DRq_!!2210123621994.png)">
    <div id="tfbk-footer-new" class="footer">
        <div style="background-image:url(https://img.alicdn.com/imgextra/i4/2210123621994/O1CN012hz5uy1QbIqZO9DRq_!!2210123621994.png)">
                    ...
                    <div class="tfbk-footer-widget-in">
                        <section id="text-3" class="widget widget_text mg-b zibtf-radius">
                            ...
                            <div class="textwidget">
                                <p>专注分享优质实用互联网资源，涵盖建站、源码、工具等多类 IT 内容，致力打造专业 IT 博客！</p>
                            </div>
                        </section>
                        ...
                        <section id="nav_menu-2" class="widget widget_nav_menu mg-b zibtf-radius">
                            ...
                            <div class="menu-footer-container">
                                <ul id="menu-footer" class="menu">
                                    ...
                                    <li><a href="/map" target="_blank">站点地图</a></li>
                                </ul>
                            </div>
                        </section>
                        
                        <section id="nav_menu-3" class="widget widget_nav_menu mg-b zibtf-radius">
                            <h2 class="widget-title footer-h">特色功能务</h2>
                            <div class="menu-footer-container">
                                <ul id="menu-footer-2" class="menu">
                                    <li><a href="/blacklist" target="_blank">小黑屋</a></li>
                                    <li><a href="/hot" target="_blank">热门标签</a></li>
                                    <li><a href="/archives" target="_blank">文章归档</a></li>
                                    <li><a href="https://www.xuwbk.com/" target="_blank">本站主题</a></li>
                        ...
                        <section id="nav_menu-4" class="widget widget_nav_menu mg-b zibtf-radius">
                            <h2 class="widget-title footer-h">用户中心</h2>
                            <div class="menu-footer-container">
                                <ul id="menu-footer-3" class="menu">
                                    <li><a href="/vip" target="_blank">会员说明</a></li>
                                    <li><a href="/user/auth" target="_blank">申请认证</a></li>
                                    <li><a href="/order-seach" target="_blank">订单查询</a></li>
                                    <li><a href="/zanzhu" target="_blank">赞助发电</a></li>
                                ...
                                <div class="row qr-container">
                                    <div class="qr-item">
                                        <div class="qr-wrapper">
                                            <img width="90" height="90" alt="关注公众号" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/footer/weix.png'); ?>" class="qr-img">
                                        </div>
                                        <p class="qr-tips">关注公众号</p>
                                    </div>
                                    <div class="qr-item">
                                        <div class="qr-wrapper">
                                            <img width="90" height="90" alt="加入群聊" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/footer/qqqun.png'); ?>" class="qr-img">
                                        </div>
                                        <p class="qr-tips">加入群聊</p>
                                    </div>
                                    <div class="qr-item">
                                        <div class="qr-wrapper">
                                            <img width="90" height="90" alt="微信小程序" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/footer/weix.png'); ?>" class="qr-img">
                                        </div>
                            ...
                            <div class="link-items">
                                ...
                                if (!empty($bookmarks)) {
                                    foreach ($bookmarks as $bookmark) {
                                        echo '<a target="_blank" href="' . esc_url($bookmark->link_url) . '" title="' . esc_attr($bookmark->link_description) . '">' . esc_html($bookmark->link_name) . '</a>';
                                    }
                                } 
                                ?>
                            </div>
                        </div>
                        <a href="https://www.xuwbk.com/links" target="_blank" class="apply-link">申请友链</a>
                    </div>
                    <div class="footer-bottom">
                        <div class="footer-bottom-container">
                            <div class="foot-copyright">
                                © 2025 轩玮博客. Xuwbk.Com All Rights Reserved.
                            </div>
                            <div class="footer-bottom-right">
                                <a rel="nofollow" target="__blank" href="#" class="icp-info">滇ICP备20001185号-88</a>
                                <span>数据库查询：<?php echo get_num_queries(); ?>次 加载耗时<?php timer_stop(3); ?> 秒</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- 悬浮导航栏CSS和JS -->
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/xuwbk_float_nav.css?v=<?php echo filemtime(get_stylesheet_directory() . '/assets/css/xuwbk_float_nav.css'); ?>">
<script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/xuwbk_float_nav.js?v=<?php echo filemtime(get_stylesheet_directory() . '/assets/js/xuwbk_float_nav.js'); ?>"></script>
