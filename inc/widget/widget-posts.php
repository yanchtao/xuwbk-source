...
class widget_ui_mini_posts extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        // 调试：输出类名和实例信息
        echo '<div style="background: #ff0000; color: white; padding: 15px; margin: 10px 0; font-weight: bold; font-size: 18px;">=== WIDGET_UI_ONELINE_POSTS EXECUTING ===</div>';
        echo '<div style="background: #333; color: #0f0; padding: 10px; margin: 10px 0; font-family: monospace;">实例数据: ' . htmlspecialchars(json_encode($instance)) . '</div>';
