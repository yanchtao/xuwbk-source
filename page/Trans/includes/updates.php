...
function mlt_updates_enqueue_styles() {
    if (isset($_GET['page']) && $_GET['page'] == 'multi-language-translate') {
        wp_enqueue_style(
            'mlt-updates-styles', 
            '/wp-content/themes/XuWbk/page/Trans/assets/css/updates.css',
            array(),
            '1.2.1'
        );
    }
...
function mlt_updates_section_callback() {
    ...
    jQuery(document).ready(function($) {
        function checkTranslateJsVersion() {
            ...
            script.src = '<?php echo esc_url(get_option('XuWbk')['js_cdn'] ?? "https://cdn.staticfile.net/translate.js/3.12.0/translate.js"); ?>';
