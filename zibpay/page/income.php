...
$all_11_c = $wpdb->get_var("SELECT COUNT(id) FROM $wpdb->zibpay_order WHERE `income_price` > 0 and `order_type` = 11 and `status` = 1");
$all_12_c = $wpdb->get_var("SELECT COUNT(id) FROM $wpdb->zibpay_order WHERE `income_price` > 0 and `order_type` = 12 and `status` = 1");
